...
const defaultElemenst = props => {
  ...
  if (props.pdY) render += `padding-top: ${props.pdY}; padding-bottom: ${props.pdY};`;
  if (props.pdX) render += `padding-left: ${props.pdX}; padding-right: ${props.pdX};`;
  ...
  if (props.mgY) render += `margin-top: ${props.mgY}; margin-bottom: ${props.mgY};`;
  if (props.mgX) render += `margin-left: ${props.mgX}; margin-right: ${props.mgX};`;
  ...
  if (props.bdY) render += `border-top: ${props.bdY}; border-bottom: ${props.bdY};`;
  if (props.bdX) render += `border-left: ${props.bdX}; border-right: ${props.bdX};`;
  ...
  if (props.bdYstyle) render += `border-top-style: ${props.bdYstyle};border-bottom-style: ${props.bdYstyle};`;
  if (props.bdXstyle) render += `border-left-style: ${props.bdXstyle};border-right-style: ${props.bdXstyle};`;
  ...
  if (props.solidWd) render += `width: ${props.solidWd};min-width: ${props.solidWd}; max-width: ${props.solidWd};`;
  ...
  if (props.solidHg) render += `height: ${props.solidWd};min-height: ${props.solidWd}; max-height: ${props.solidWd};`;
  if (props.wdHg) render += `width: ${props.wdHg}; height: ${props.wdHg};`;
  if (props.dimensions) render += `width: ${props.dimensions}; min-width: ${props.dimensions}; height: ${props.dimensions}; min-height: ${props.dimensions};`;
  ...
  if (props.placeholderStyle) render += `
  ...
  if (props.justifyContent) render += `justify-content: ${props.justifyContent};`;
  ...
  if (props.hover) render += `&:hover ${props.hoverEffectEl || ""}{${defaultElemenst(props.hover)}}`;
  if (props.hoverThis) render += `&:hover{${defaultElemenst(props.hoverThis)}}`;
  if (props.focus) render += `&:focus ${props.focusEffectEl || ""}{${defaultElemenst(props.focus)}}`;
  if (props.focusThis) render += `&:focus{${defaultElemenst(props.focusThis)}}`;
  if (props.focusWin) render += `&:focus-within ${props.focusWinEffectEl || ""}{${defaultElemenst(props.focusWin)}}`;
  if (props.focusWinThis) render += `&:focus-within {${defaultElemenst(props.focusWinThis)}}`;
  if (props.active) render += `&:active ${props.activeEffectEl || ""}{${defaultElemenst(props.active)}}`;
    ...
    if (Array.isArray(props._mediaScrean)) {
      if (props._mediaScrean.length > 0) {
        for (const element of props._mediaScrean) {
          render += `@media only screen and (${element.dimensions}){${defaultElemenst(element.style)}${element.pureStyle ? element.pureStyle : ""}}`;
        }
      }
    } else render += `@media only screen and (${props._mediaScrean.dimensions}){${defaultElemenst(props._mediaScrean.style)}${props._mediaScrean.pureStyle ? props._mediaScrean.pureStyle : ""}}`;
  }
